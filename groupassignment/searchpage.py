# -*- coding: utf-8 -*-
# PyQt5 + LSTM Stock Predictor using yfinance
...
class SearchPage(QtWidgets.QMainWindow):
    def __init__(self, username=None):
        ...
        from homepage import HomePage  # Make sure this import is allowed (adjust if circular import error occurs)
        self.ui.backButton.clicked.connect(self.go_back)

    def go_back(self):
        from homepage import HomePage  # moved import here
...
#analyse it.
    ...
    def run_prediction(self):
        ...
        self.ui.pushButton.setEnabled(False)  # Disable Predict button
        ...
        try:
            ...
            self.ui.pushButton.setEnabled(True)  # Re-enable Predict button
